...
SELECT
    ...
    name AS record_name
FROM session_history
LEFT JOIN user_account u ON session_history.changed_by_user_id = u.user_id
...
FROM session_instance_history
LEFT JOIN user_account u ON session_instance_history.changed_by_user_id = u.user_id
WHERE changed_at >= CURRENT_DATE - INTERVAL '30 days'
UNION ALL
SELECT
    changed_at,
    ...
    name AS record_name
FROM tune_history
LEFT JOIN user_account u ON tune_history.changed_by_user_id = u.user_id
WHERE changed_at >= CURRENT_DATE - INTERVAL '30 days'
UNION ALL
SELECT
    changed_at,
...
FROM session_tune_history
LEFT JOIN user_account u ON session_tune_history.changed_by_user_id = u.user_id
WHERE changed_at >= CURRENT_DATE - INTERVAL '30 days'
UNION ALL
SELECT
    changed_at,
    ...
    name AS record_name
FROM session_instance_tune_history
LEFT JOIN user_account u ON session_instance_tune_history.changed_by_user_id = u.user_id
WHERE changed_at >= CURRENT_DATE - INTERVAL '30 days'
...
BEGIN
    ...
    LEFT JOIN user_account u ON sh.changed_by_user_id = u.user_id
    ...
    LEFT JOIN user_account u ON sih.changed_by_user_id = u.user_id
    ...
    LEFT JOIN user_account u ON th.changed_by_user_id = u.user_id
    ...
    LEFT JOIN user_account u ON sth.changed_by_user_id = u.user_id
