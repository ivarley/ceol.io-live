-- Updated stored procedure to insert a tune into session_instance_tune table
-- This version saves to history table after insert (for INSERT operation tracking)
...
BEGIN
    ...
    SELECT session_instance_tune_id, 'INSERT', 'system', session_instance_id, tune_id, 
           name, order_number, continues_set, played_timestamp, inserted_timestamp, 
           key_override, setting_override, created_date, last_modified_date
    FROM session_instance_tune 
    WHERE session_instance_tune_id = v_new_id;
